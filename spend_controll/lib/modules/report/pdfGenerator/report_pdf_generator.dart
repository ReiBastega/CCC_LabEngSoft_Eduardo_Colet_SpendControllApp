...
//       .replaceAll('{{TOTAL_INCOME}}', 'R\$ ${state.totalIncome.toStringAsFixed(2)}')
//       .replaceAll('{{TOTAL_EXPENSE}}', 'R\$ ${state.totalExpense.toStringAsFixed(2)}')
//       .replaceAll('{{TOTAL_BALANCE}}', 'R\$ ${(state.totalIncome - state.totalExpense).toStringAsFixed(2)}');
...
//       html = html.replaceAll('{{TRANSACTIONS_TABLE}}', _generateTransactionsTableHtml(state));
//     } else {
...
//       html = html.replaceAll('{{INSIGHTS_SECTION}}', _generateInsightsHtml(state));
//     } else {
