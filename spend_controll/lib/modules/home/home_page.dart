      ...
      body: BlocBuilder<HomeController, HomeState>(
        ...
        builder: (context, state) {
          ...
          return SingleChildScrollView(
            ...
            padding:
                const EdgeInsets.only(top: 56, bottom: 32, left: 24, right: 24),
            child:
          ...
          builder: (context, state) {
            return SingleChildScrollView(
              ...
              padding: const EdgeInsets.only(
                  left: 24, right: 24, bottom: 32, top: 72),
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: () {
                          Modular.to
                              .pushNamed('/transactions/transaction_home/');
                        },
                  ...
                  RecentTransactionsWidget(
                    transactions:
                        widget.homeController.state.recentTransactions,
                    onTransactionTap: (transaction) async {
                      await Modular.to.pushNamed(
                          '/transactions/transaction_home',
